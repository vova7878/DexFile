...
public final class InstructionN1t extends Instruction
        implements OneRegisterInstruction, BranchOffsetInstruction {
    private final int register1;
    private final int branch_offset;

    private InstructionN1t(Opcode opcode, int register1, int branch_offset) {
        super(Preconditions.checkFormat(opcode, "N1t", Format21t, Format31t));
        this.register1 = Preconditions.checkByteRegister(register1);
        this.branch_offset = switch (opcode.format()) {
            case Format21t -> Preconditions.checkShortCodeOffset(branch_offset);
            case Format31t -> branch_offset;
            default -> throw shouldNotReachHere();
        };
    }

    public static InstructionN1t of(Opcode opcode, int register1, int branch_offset) {
        return new InstructionN1t(opcode, register1, branch_offset);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof InstructionN1t other
