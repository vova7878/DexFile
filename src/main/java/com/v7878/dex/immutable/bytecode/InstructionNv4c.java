...
public final class InstructionNv4c extends Instruction
    ...
    private InstructionNv4c(Opcode opcode, int register_count, int register1,
                            int register2, int register3, int register4, Object reference1) {
        super(Preconditions.checkFormat(opcode, "Nv4c", Format34c));
    ...
    public static InstructionNv4c of(Opcode opcode, int register_count, int register1,
                                     int register2, int register3, int register4, Object reference1) {
        return new InstructionNv4c(opcode, register_count,
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof InstructionNv4c other
