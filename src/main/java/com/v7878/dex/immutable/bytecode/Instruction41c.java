...
public final class Instruction41c extends Instruction
        implements OneRegisterInstruction, SingleReferenceInstruction {
    private final int register1;
    private final Object reference1;

    private Instruction41c(Opcode opcode, int register1, Object reference1) {
        super(Preconditions.checkFormat(opcode, Format41c));
    ...
    public static Instruction41c of(Opcode opcode, int register1, Object reference1) {
        return new Instruction41c(opcode, register1, reference1);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof Instruction41c other
