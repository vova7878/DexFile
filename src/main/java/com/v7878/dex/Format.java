...
public enum Format {
    Format10t(1) {
        @Override
        public Instruction read(Opcode opcode, RandomInput in, int arg, ReferenceIndexer indexer) {
    ...
    public abstract Instruction read(Opcode opcode, RandomInput in, int arg, ReferenceIndexer indexer);
}
